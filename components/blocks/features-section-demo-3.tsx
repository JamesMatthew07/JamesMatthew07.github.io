...
export default function FeaturesSectionDemo() {
  const features = [
    {
      link: "https://jamesmatthew07.github.io/jamesdev.github.io/",
      title: "Switzerland Landing Page",
      description:
        "Helping you explore the wonders of the country, 'Switzerland'. ",
      skeleton: <SkeletonOne />,
      className:
        "col-span-1 lg:col-span-4 border-b lg:border-r dark:border-neutral-800",
    },
    {
      title: "Ecosia Brochure",
      description:
        "Helping the world with a simple search,'Ecosia'.",
  ...
  return (
    <div className="relative z-20 py-10 lg:py-40 max-w-7xl mx-auto">
      <div className="px-8">
        ...
        Explore a showcase of innovative projects, featuring my latest work in AI, web development, and sustainable tech solutions.
        </p>
      </div>
...
export const SkeletonOne = () => {
  return (
  <Link href={"https://jamesmatthew07.github.io/jamesdev.github.io/"}>
    <div className="relative flex py-4 px-2 gap-10 h-auto cursor-pointer">
      <div className="w-auto p-4 mx-auto shadow-2xl group h-full">
        <div className="flex flex-1 w-full h-full flex-col space-y-2  ">
          {/* TODO */}
          <Image
            src="https://i.imgur.com/KzJL7h2.jpg"
            alt="header"
            width={800}
            height={800}
            quality={100}
...
export const SkeletonTwo = () => {
  const images = [
    "https://i.pinimg.com/originals/a0/9c/c7/a09cc77b6b3ad0dadd0000663841a0c4.jpg",
    "https://cdn.venngage.com/template/thumbnail/small/3a3ac404-2f69-47cc-aff5-97f24644ca7c.webp",
    "https://image.freepik.com/free-vector/world-environment-day-brochure_1057-951.jpg",
  ];
  ...
  return (
    <Link href="https://www.canva.com/design/DAGTOhL1llA/lOOfWNYVGqVectNOkDmi1Q/view?utm_content=DAGTOhL1llA&utm_campaign=designshare&utm_medium=link&utm_source=editor">
      ...
      <div className="flex flex-row -ml-20">
        {images.map((image, idx) => (
          <motion.div
            ...
            whileTap="whileTap"
            className="rounded-xl -mr-4 mt-4 p-1 bg-neutral-900 dark:bg-neutral-800 dark:border-neutral-700 border border-neutral-900 flex-shrink-0 overflow-hidden"
          >
            <Image
              src={image}
              alt="bali images"
      ...
      <div className="flex flex-row">
        {images.map((image, idx) => (
          <motion.div
            ...
            whileHover="whileHover"
            whileTap="whileTap"
            className="rounded-xl -mr-4 mt-4 p-1 bg-neural-900 dark:bg-neutral-800 dark:border-neutral-700 border border-neutral-100 flex-shrink-0 overflow-hidden"
          >
            <Image
              src={image}
              alt="bali images"
